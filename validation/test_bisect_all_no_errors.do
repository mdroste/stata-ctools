/*******************************************************************************
 * test_bisect_all_no_errors.do - Run full validation EXCEPT error tests, then clear all
 ******************************************************************************/
...
noi di as text "Running all sections EXCEPT error tests then clear all..."
...
/*******************************************************************************
 * SECTION 16: Display options - SKIP for now (simplify)
 ******************************************************************************/
...
/*******************************************************************************
 * SKIPPING SECTIONS 18-25 and ERROR TESTS for now
 ******************************************************************************/
