...
noi di as text "  Running sort benchmarks (csort vs sort)"
...
noi di as text "  Running speed merge benchmarks (cmerge vs. merge)"
...
noi di as text "  Running reghdfe speed benchmarks (creghdfe vs. reghdfe)"
...
noi di as text "  Running qreg speed benchmarks (cqreg vs. qreg)"
...
noi di as text "  Running ivreghdfe speed benchmarks (civreghdfe vs. ivreghdfe)"
...
noi di as text "  Running binscatter speed benchmarks (cbinscatter vs. binscatter)"
...
noi di as text "  Running import/export speed benchmarks..."
...
noi di as text "  Running decode benchmarks (cdecode vs decode)"
...
noi di as text "  Running encode benchmarks (cencode vs encode)"
...
noi di as text "  Running destring benchmarks (cdestring vs destring)"
...
noi di as text "  Running winsor benchmarks (cwinsor vs winsor2)"
...
noi di as text "  Running sample benchmarks (csample vs sample)"
...
noi di as text "  Running bsample benchmarks (cbsample vs bsample)"
...
noi di as text "  Running rangestat benchmarks (crangestat vs rangestat)"
...
noi di as text "  Running psmatch benchmarks (cpsmatch vs psmatch2)"
...
noi di as text ""
noi di as text "IMPORT/EXPORT (N=`N'):"
