...
program define ctools
    ...
    di as text "  {help csort:csort}      - High-performance radix sort"
    di as text "  {help cmerge:cmerge}     - C-accelerated merge"
    di as text "  {help cimport:cimport}    - High-performance CSV import"
    di as text "  {help cexport:cexport}    - High-performance CSV export"
    di as text "  {help creghdfe:creghdfe}   - C-accelerated reghdfe (HDFE regression)"
    di as text ""
