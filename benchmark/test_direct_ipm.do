* Test direct IPM performance
clear all
set more off
adopath + "../build"

di "{hline 60}"
di "Direct IPM Performance Test"
di "{hline 60}"
...
foreach N in 1000 5000 10000 25000 50000 {
    ...
    * Check correctness
    ...
    di "N=" %6.0fc `N' "  qreg=" %6.3f `qreg_time' "s  cqreg=" %6.3f `cqreg_time' "s  speedup=" %5.1f `speedup' "x  diff=" %8.5f `max_diff' "  " "`correct'"
}
