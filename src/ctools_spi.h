...
/* ============================================================================
   Batched String Write Macros
   ============================================================================ */

/*
 * Batch write 8 string values to Stata.
 */
#define SF_SSTORE_BATCH8(var, obs_base, in) do { \
    SF_sstore((var), (ST_int)(obs_base),       (in)[0]); \
    SF_sstore((var), (ST_int)((obs_base) + 1), (in)[1]); \
    SF_sstore((var), (ST_int)((obs_base) + 2), (in)[2]); \
    SF_sstore((var), (ST_int)((obs_base) + 3), (in)[3]); \
    SF_sstore((var), (ST_int)((obs_base) + 4), (in)[4]); \
    SF_sstore((var), (ST_int)((obs_base) + 5), (in)[5]); \
    SF_sstore((var), (ST_int)((obs_base) + 6), (in)[6]); \
    SF_sstore((var), (ST_int)((obs_base) + 7), (in)[7]); \
} while(0)

/*
 * Batch write 16 string values to Stata.
 */
#define SF_SSTORE_BATCH16(var, obs_base, in) do { \
    SF_sstore((var), (ST_int)(obs_base),        (in)[0]); \
    SF_sstore((var), (ST_int)((obs_base) + 1),  (in)[1]); \
    SF_sstore((var), (ST_int)((obs_base) + 2),  (in)[2]); \
    SF_sstore((var), (ST_int)((obs_base) + 3),  (in)[3]); \
    ...
    SF_sstore((var), (ST_int)((obs_base) + 6),  (in)[6]); \
    SF_sstore((var), (ST_int)((obs_base) + 7),  (in)[7]); \
    SF_sstore((var), (ST_int)((obs_base) + 8),  (in)[8]); \
    SF_sstore((var), (ST_int)((obs_base) + 9),  (in)[9]); \
    SF_sstore((var), (ST_int)((obs_base) + 10), (in)[10]); \
    SF_sstore((var), (ST_int)((obs_base) + 11), (in)[11]); \
    SF_sstore((var), (ST_int)((obs_base) + 12), (in)[12]); \
    SF_sstore((var), (ST_int)((obs_base) + 13), (in)[13]); \
    SF_sstore((var), (ST_int)((obs_base) + 14), (in)[14]); \
    SF_sstore((var), (ST_int)((obs_base) + 15), (in)[15]); \
} while(0)
